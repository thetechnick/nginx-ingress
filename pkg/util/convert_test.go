...
func TestGetMapKeyAsBool(t *testing.T) {
	...
	b, exists, err := GetMapKeyAsBool(configMap.Data, "key")
	if !exists {
...
func TestGetMapKeyAsBoolNotFound(t *testing.T) {
	...
	_, exists, _ := GetMapKeyAsBool(configMap.Data, "key")
	if exists {
...
func TestGetMapKeyAsBoolErrorMessage(t *testing.T) {
	...
	// Test with configmap
	_, _, err := GetMapKeyAsBool(cfgm.Data, "key")
	if err == nil {
		t.Error("An error was expected")
	}
	expected := `strconv.ParseBool: parsing "string": invalid syntax`
	...
	_, _, err = GetMapKeyAsBool(ingress.Annotations, "key")
	if err == nil {
		t.Error("An error was expected")
	}
	expected = `strconv.ParseBool: parsing "other_string": invalid syntax`
	if err.Error() != expected {
		t.Errorf("The error message does not match expectations:\nGot: %v\nExpected: %v", err, expected)
	}
}
...
func TestGetMapKeyAsInt(t *testing.T) {
	...
	i, exists, err := GetMapKeyAsInt(configMap.Data, "key")
	if err != nil {
		t.Errorf("Unexpected error: %v", err)
	}
	if !exists {
...
func TestGetMapKeyAsIntNotFound(t *testing.T) {
	...
	_, exists, _ := GetMapKeyAsInt(configMap.Data, "key")
	if exists {
		t.Errorf("The key 'key' must not exist in the configMap")
	}
}
...
func TestGetMapKeyAsIntErrorMessage(t *testing.T) {
	...
	// Test with configmap
	_, _, err := GetMapKeyAsInt(cfgm.Data, "key")
	if err == nil {
		t.Error("An error was expected")
	}
	expected := `strconv.ParseInt: parsing "string": invalid syntax`
	if err.Error() != expected {
		t.Errorf("The error message does not match expectations:\nGot: %v\nExpected: %v", err, expected)
	}
	...
	_, _, err = GetMapKeyAsInt(ingress.Annotations, "key")
	if err == nil {
		t.Error("An error was expected")
	}
	expected = `strconv.ParseInt: parsing "other_string": invalid syntax`
	if err.Error() != expected {
		t.Errorf("The error message does not match expectations:\nGot: %v\nExpected: %v", err, expected)
	}
}
